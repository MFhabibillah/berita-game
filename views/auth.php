    ...
    <div class="auth-container">
        <div class="auth-form">
            <div class="tab-container">
                <h5>Welcome To GAMER SOCIETY</h5>
                ...
                <div class="tab-contents">
                    <div class="tab-content active" id="login">
                        <form action="/gamersociety/controllers/auth/logincontroller.php" method="POST">
                    ...
                    <div class="tab-content" id="register">
                        <form action="/gamersociety/controllers/auth/registercontroller.php" method="POST">
                            <div class="form-group">
